...
#list
coffee_list = ["Espresso", "Cappuccino", "Latte"]
type_list = ["Hot", "Cold"]
price_list = ["55", "60"]
coffee_list_2 = [1, 2, 3]
type_list_2 = [1, 2]
...
type_menu = "---Choose type of the coffee--- \n 1.Hot 55 Baht \n 2.Cold 60 Baht"
...
def price_function():
    ...
    if coffee_pay > int(price_list[coffee_type-1]):
        print(f"You received a change of {coffee_pay-int(price_list[coffee_type-1])} bath")
...
#main program
print("---Welcome to Peak's coffee---")
show_menu_function()
if show_menu == 1:
    print(menu)
